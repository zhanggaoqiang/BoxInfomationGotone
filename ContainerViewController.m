...
- (Topbar *)topbar {
    if (!_topbar) {
        _topbar = [[Topbar alloc] initWithFrame:CGRectMake(0, [[UIApplication sharedApplication] statusBarFrame].size.height, CGRectGetWidth(self.view.frame), kTopbarHeight)];
